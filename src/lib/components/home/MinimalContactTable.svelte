...
<table class="social-table">
	...
	<tr>
		<td>
			<img src="/images/logos/discord-mark-blue.svg" alt="Discord logo" width=26 height=20 />Discord
		</td>
		<td
			><a
	...
	<tr>
		<td title="My Discord server">
			<img src="/images/logos/discord-mark-blue.svg" alt="Discord logo" width=26 height=20 />Discord(server)
		</td>
		<td
